...
**Key files**: `app/services/chess_log_stats_service.py`, `app/services/chess_log_narrative_service.py`, `app/controllers/chess_log_charts_controller.py`, `app/controllers/chess_log_controller.py`, `app/views/detail_chess_log_charts_view.py`, `app/views/widgets/chess_log_category_chart_widget.py`, `app/views/widgets/busy_spinner.py`, `app/views/dialogs/_tag_row_helpers.py`, `app/views/dialogs/show_tags_dialog.py`, `app/views/dialogs/show_shallow_tags_dialog.py`, `app/utils/ai_provider_config.py`.
