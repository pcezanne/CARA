...
**DRY debt (future PR)**: `ChessLogChartsMenuController` and `PlayerStatsTimeSeriesMenuController` share ~80% structure — a `RadioMenuController` base class would remove ~150 lines of duplication.
